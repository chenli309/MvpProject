...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_msv_emptyView, R.layout.multiple_status_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_msv_errorView, R.layout.multiple_status_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_msv_loadingView, R.layout.multiple_status_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_msv_noNetworkView, R.layout.multiple_status_network_view);
    ...
    public final void showEmpty() {
        showEmpty(mEmptyViewResId, DEFAULT_LAYOUT_PARAMS, true);
    }

    /**
     * 显示空视图
     */
    public final void showEmpty(boolean isRetry) {
        showEmpty(mEmptyViewResId, DEFAULT_LAYOUT_PARAMS, isRetry);
    }
     ...
     */
    public final void showEmpty(int layoutId, ViewGroup.LayoutParams layoutParams, boolean isRetry) {
        showEmpty(inflateView(layoutId), layoutParams, isRetry);
    }
     ...
     * @param layoutParams 布局参数
     */
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams, boolean isRetry) {
        checkNull(view, "Empty view is null!");
        mViewStatus = STATUS_EMPTY;
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(R.id.cl_status_empty);
            if (null != mOnRetryClickListener && null != emptyRetryView && isRetry) {
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mErrorView) {
            mErrorView = view;
            View errorRetryView = mErrorView.findViewById(R.id.cl_status_error);
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mNoNetworkView) {
            mNoNetworkView = view;
            View noNetworkRetryView = mNoNetworkView.findViewById(R.id.cl_status_network);
